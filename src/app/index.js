  ...
  return (
    <SafeAreaView style={loginStyle.container}>
      <View style={loginStyle.logoSection}>
        <Image source={require('../assets/login.jpg')} style={loginStyle.logo} />
        <Text style={loginStyle.title}>Mobile Programming</Text>
        <Text style={loginStyle.subtitle}>Achieve More with Us</Text>
      </View>
